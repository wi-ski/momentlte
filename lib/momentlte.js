...
var momentlte = function(dateObjOrString){
    ...
    if(ISOStringPassed){
        ...
        _date = new Date.UTC(dateObjOrString);
    }else if(FunctionPassed && dateObjOrString._isAMomentObject){
        _date = dateObjOrString._date;
    }else{
        _date = new Date();
    }
    ...
    _response.toISOString = function(){ //Todo: Make is so this format implementation works with your desired format
